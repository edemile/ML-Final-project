...
To run the Random Forest model, open and execute the notebook `DS4400_Project_Random_Forest.ipynb`. To run the Support Vector Machine (SVM) model, open and execute `DS4400_Project_SVM.ipynb`. Both of these notebooks use the same dataset, provided as a spreadsheet version of the modeling dataset, which can be accessed here: https://docs.google.com/spreadsheets/d/1K9R2xpxjPZYypVshY3fKUC5-VHWPgP0KxQivMES2zsQ/edit?usp=sharing
